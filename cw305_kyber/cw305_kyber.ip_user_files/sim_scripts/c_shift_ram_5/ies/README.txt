...
#
# Generated by export_simulation on Sat Oct 07 23:22:34 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_5.sh' script.

./c_shift_ram_5.sh -reset_run
...
./c_shift_ram_5.sh -noclean_files

For more information on the script, please type './c_shift_ram_5.sh -help'.
