...
#
# Generated by export_simulation on Sat Oct 07 23:25:01 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_11.sh' script.

./c_shift_ram_11.sh -reset_run
...
./c_shift_ram_11.sh -noclean_files

For more information on the script, please type './c_shift_ram_11.sh -help'.
