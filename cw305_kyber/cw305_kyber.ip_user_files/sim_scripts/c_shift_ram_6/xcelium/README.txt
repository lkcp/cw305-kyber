...
#
# Generated by export_simulation on Sat Oct 07 23:23:31 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_6.sh' script.

./c_shift_ram_6.sh -reset_run
...
./c_shift_ram_6.sh -noclean_files

For more information on the script, please type './c_shift_ram_6.sh -help'.
