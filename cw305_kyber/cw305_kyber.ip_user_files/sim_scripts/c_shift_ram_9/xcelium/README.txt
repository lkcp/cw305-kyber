...
#
# Generated by export_simulation on Sat Oct 07 23:27:30 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_9.sh' script.

./c_shift_ram_9.sh -reset_run
...
./c_shift_ram_9.sh -noclean_files

For more information on the script, please type './c_shift_ram_9.sh -help'.
