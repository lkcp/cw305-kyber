...
#
# Generated by export_simulation on Sun Oct 08 09:19:12 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './fifo_generator_4.sh' script.

./fifo_generator_4.sh -reset_run
...
./fifo_generator_4.sh -noclean_files

For more information on the script, please type './fifo_generator_4.sh -help'.
